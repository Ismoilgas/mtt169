    ...
    <div class="ftco-blocks-cover-1">
      ...
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url({{asset('public/images/img_13.jpg')}}">
        <div class="container">
          <div class="row align-items-center ">

            <div class="col-md-5 mt-5 pt-5">
              <!-- <span class="text-cursive h5 text-red">Welcome To Our Website</span> -->
              <h1 class="mb-3 font-weight-bold text-teal">Yangiliklar</h1>
              <p><a href="index.html" class="text-white">Asosiy</a> <span class="mx-3">/</span> <strong>Yangiliklar</strong></p>
            </div>
        ...
        <div class="row align-items-stretch">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div>
                ...
                <img src="{{asset('public/images/img_11.jpg')}}" alt="Image"
                 class="img-fluid">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="{{asset('images/flaticon/svg/001-jigsaw.svg')}}" alt="Image" class="img-fluid"></span>
          ...
          <div class="col-lg-4">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="{{asset('images/flaticon/svg/002-target.svg')}}" alt="Image" class="img-fluid"></span>
          ...
          <div class="col-lg-4">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="{{asset('images/flaticon/svg/003-mission.svg')}}" alt="Image" class="img-fluid"></span>
              ...
              <div class="owl-carousel nonloop-block-13">
                <div class="testimonial-3 d-flex">
                  <div class="vcard-wrap mr-5">
                    <img src="{{asset('public/images/person_1.jpg')}}" alt="Image" class="vcard img-fluid">
                  </div>
                  <div class="text">
                    <h3>Jeff Woodland</h3>
                ...
                <div class="testimonial-3 d-flex">
                  <div class="vcard-wrap mr-5">
                    <img src="{{asset('public/images/person_3.jpg')}}" alt="Image" class="vcard img-fluid">
                  </div>
                  <div class="text">
                    <h3>Jeff Woodland</h3>
                    <p class="position">Partner</p>
                ...
                <div class="testimonial-3 d-flex">
                  <div class="vcard-wrap mr-5">
                    <img src="{{asset('public/images/person_2.jpg')}}" alt="Image" class="vcard img-fluid">
                  </div>
                  <div class="text">
                    <h3>Jeff Woodland</h3>
                    <p class="position">Partner</p>
