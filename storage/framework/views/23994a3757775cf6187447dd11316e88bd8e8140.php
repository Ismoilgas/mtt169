        ...
        <div class="container">
          <div class="row align-items-center ">
            <div class="col-md-5 mt-5 pt-5">
              <span class="text-cursive h5 text-red">Jajji bilimdonlar saytiga hush kelibsiz</span>
              <h1 class="mb-3 font-weight-bold text-teal">Farzandingiz hayotiga birga zavq keltiramiz</h1>
              
            </div>
            <div class="col-md-6 ml-auto align-self-end">
              <img src="<?php echo e(asset('public/images/kid_transparent.png')); ?>" alt="Image" class="img-fluid">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            ...
            <h2 class="text-white">Bizning mashg'ulotlar</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4">
            <div class="package text-center bg-white">
              ...
              <h3 class="text-teal">To'garaklar</h3>
          ...
          <div class="col-lg-4">
            <div class="package text-center bg-white">
              ...
              <h3 class="text-success">Jismoniy tarbiya</h3>
              <!-- <p>Lorem ipsum dolor sit amet. Consequatur aliquam, fuga maiores amet quo corporis distinctio soluta recusandae?</p> -->
          ...
          <div class="col-lg-4">
            <div class="package text-center bg-white">
              ...
              <h3 class="text-danger">Musobaqalar</h3>
              <!-- <p>Lorem ipsum dolor sit amet. Consequatur aliquam, fuga maiores amet quo corporis distinctio soluta recusandae?</p> -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            <img src="<?php echo e(asset('public/images/img_1.jpg')); ?>" alt="Image" class="img-fluid">
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="<?php echo e(asset('public/images/flaticon/svg/001-jigsaw.svg')); ?>" alt="Image" class="img-fluid"></span>
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="<?php echo e(asset('public/images/flaticon/svg/002-target.svg')); ?>" alt="Image" class="img-fluid"></span>
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="<?php echo e(asset('public/images/flaticon/svg/003-mission.svg')); ?>" alt="Image" class="img-fluid"></span>
              ...
              <div class="owl-carousel nonloop-block-13">
                <div class="testimonial-3 d-flex">
                  <div class="vcard-wrap mr-5">
                    <img src="<?php echo e(asset('public/images/person_1.jpg')); ?>" alt="Image" class="vcard img-fluid">
                  </div>
                  <div class="text">
                    <h3>Jeff Woodland</h3>
                ...
                <div class="testimonial-3 d-flex">
                  <div class="vcard-wrap mr-5">
                    <img src="<?php echo e(asset('public/images/person_3.jpg')); ?>" alt="Image" class="vcard img-fluid">
                  </div>
                  <div class="text">
                    <h3>Jeff Woodland</h3>
                    <p class="position">Partner</p>
                ...
                <div class="testimonial-3 d-flex">
                  <div class="vcard-wrap mr-5">
                    <img src="<?php echo e(asset('public/images/person_2.jpg')); ?>" alt="Image" class="vcard img-fluid">
                  </div>
                  <div class="text">
                    <h3>Jeff Woodland</h3>
                    <p class="position">Partner</p>
     ...
     -->    <div class="row mt-5 justify-content-center">
          ...
          <div class="col-md-8">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 text-center">
                <span class="text-yellow h2 d-block">10+</span>
                <span class="text-yellow h2 d-block">Tarbiyachilar</span>
              </div>
             
              <div class="col-lg-3 text-center">
                <span class="text-teal h2 d-block">220+</span>
                <span class="text-teal h2 d-block">Bolajonlar</span>
              </div>
            </div>
    ...
    <div class="site-section py-5 bg-warning">
      <div class="container">
        <div class="row justify-content-center">
          ...
          <h2 class="text-white m-0">Farzandlarimiz kelajagi sari birga</h2>
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel-test/resources/views/front/index.blade.php ENDPATH**/ ?>