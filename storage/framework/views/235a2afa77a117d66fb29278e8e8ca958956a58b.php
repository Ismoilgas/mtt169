    ...
    <div class="ftco-blocks-cover-1">
      ...
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('<?php echo e(asset('public/images/img_9.jpg')); ?>">
        <div class="container">
   ...
   <!--  <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="<?php echo e(asset('public/images/img_8.jpg')); ?>" alt="Image" class="img-fluid">
          </div>
...
<?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="col-lg-4 col-md-6 mb-5">
            ...
            <div class="post-entry-1 h-100 person-1 teal">
                ...
                <img src="<?php echo e(asset('public/images/' . $teacher->image)); ?>" alt="Image"
                 class="img-fluid">
            
              <div class="post-entry-1-contents">
                <span class="meta"><?php echo e($teacher->position); ?></span>
          ...
          <!-- <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1 yellow">
                ...
                <img src="<?php echo e(asset('public/images/person_2.jpg')); ?>" alt="Image"
                 class="img-fluid">
...
<!--           <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1 red">
                ...
                <img src="<?php echo e(asset('public/images/person_3.jpg')); ?>" alt="Image"
                 class="img-fluid">
...
<!--           <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1 green">
                ...
                <img src="<?php echo e(asset('public/images/person_4.jpg')); ?>" alt="Image"
                 class="img-fluid">
...
<!--           <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1 blue">
                ...
                <img src="<?php echo e(asset('public/images/person_5.jpg')); ?>" alt="Image"
                 class="img-fluid">
...
<!--           <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1 red">
                ...
                <img src="<?php echo e(asset('public/images/person_1.jpg')); ?>" alt="Image"
                 class="img-fluid">
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel-test/resources/views/front/about.blade.php ENDPATH**/ ?>