...
<html>
    <head>
        ...
        <!-- <link rel="stylesheet" href="<?php echo e(asset('public/js/jquery-3.2.1.min.js')); ?>"> -->
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="<?php echo e(url('/dashboard')); ?>">
                        <i class="fa fa-folder-o"></i> <span>Hodimlar ro'yhati</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('products.create')); ?>">
                        <i class="fa fa-folder-o"></i> <span>Hodimlarni qo'shish</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(url('/gallery')); ?>">
                        <i class="fa fa-folder-o"></i> <span>Galeriya</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('photo.create')); ?>">
                        <i class="fa fa-folder-o"></i> <span>Galeriyani yangilash</span>
                    </a>
                </li>
...
<?php /**PATH /var/www/html/laravel-test/resources/views/back/layout.blade.php ENDPATH**/ ?>